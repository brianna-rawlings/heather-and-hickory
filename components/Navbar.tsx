    ...
    <>
      <nav className="fixed top-0 left-0 z-50 w-full transition-all duration-500 ease-in-out !bg-transparent hover:!bg-[#435e48] px-8 py-6 grid grid-cols-3 items-center group/nav">
        ...
        <div className="flex justify-center">
          <Link href="/">
            <h1 
              className="text-2xl lg:text-4xl tracking-tight transition-colors duration-300 text-[#4c2a17] group-hover/nav:text-white" 
        ...
        <div className="flex justify-end items-center gap-4">
          ...
          <button
            ...
            className="lg:hidden text-[#4c2a17] group-hover/nav:text-white transition-colors duration-300"
          >
      ...
      {/* MOBILE MENU OVERLAY */}
      {mobileOpen && (
        <div className="fixed inset-0 z-[100] bg-[#435e48] flex flex-col px-8 py-8">
          {/* Header */}
          ...
          <div className="flex flex-col space-y-8">
            ...
            <div>
              <button
                ...
                className="flex items-center justify-between w-full text-white text-xs uppercase tracking-[0.3em] font-bold"
              >
                The Hickory Shop
                ...
                <div className="mt-4 ml-4 flex flex-col space-y-4">
                  {shopCategories.map(category => (
                    <Link
                      ...
                      className="text-white/70 text-xs uppercase tracking-[0.2em] hover:text-white transition-colors"
                    >
                      {category.name}
                    </Link>
                  ))}
            ...
            <Link
              href="/story"
              onClick={() => setMobileOpen(false)}
              className="text-white text-xs uppercase tracking-[0.3em] font-bold hover:text-white/70 transition-colors"
            >
              Our Heritage
            </Link>
